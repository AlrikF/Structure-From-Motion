...
def set_arguments(parser):
    ...
    parser.add_argument('--data_dir',action='store',type=str,default='./SfM_quality_evaluation/Benchmarking_Camera_Calibration_2008/fountain-P11/images',
    ...
    parser.add_argument('--out_dir',action='store',type=str,default='./SfM_quality_evaluation/Benchmarking_Camera_Calibration_2008/fountain-P11/',
...
def feat_match(opts, data_files=[], debug =False):
    """
...
if __name__ == '__main__':
    ...
    # feature matching
    feat_match(opts, opts.data_files, debug=True)